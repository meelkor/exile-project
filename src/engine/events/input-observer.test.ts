...
import { CursorEventType, InputObserver } from '@exile/engine/events/input-observer';
import { Injector } from '@exile/utils/di';


describe('@exile/engine/input-observer', function () {
